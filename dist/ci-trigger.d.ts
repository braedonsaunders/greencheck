...
export declare function waitForWorkflowCompletion(octokit: Octokit, owner: string, repo: string, branch: string, headSha: string, timeoutMs?: number, cooldownMs?: number): Promise<CIWorkflowRun | null>;
